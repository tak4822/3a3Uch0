    ...
    <div class="front-page-container">
        <section class="first-view">
            <div class="first-view-contents">
                <h1 class="kakucho-name">KAKUCHO</h1>
                <h3 class="front-page-text">現実世界を拡張し、<br/>新しい社会の実現を目指す</h3>
            </div>
        </section>
        <section class="second-view">
            <svg class="front-view-triangle"  xmlns="http://www.w3.org/2000/svg" viewBox="11916.184 5967.636 449.729 579.558">
                <path id="Path_47" data-name="Path 47" class="cls-1" d="M11975.483,6087.673l299.758,414.521,149.971-579.558Z" transform="translate(-59.3 45)"/>
            </svg>
            <h2 class="philosophy">現実世界を<br/>拡張し、<br/>新しい社会の<br/>実現を目指す</h2>
